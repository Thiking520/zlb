...
<body>
			...
			<div>
				<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-user"></i>商品管理>商品属性管理</h2>
					</div>
							...
							<form role="form" class="form-inline" id="searchForm" action="#" onSubmit="return false;" method="get">
								<div class="controls controls-row">
									<div class="form-group">
										<span>属性名称：</span><input type="text" name="searchKeyword" id="searchKeyword" class="form-control input-small" style="width: 150px;"/>
									</div>
							        <div class="form-group">
	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body" >
	        	<form id="addForm" class="form-horizontal" onSubmit="return false;">
	        		<div class="form-group">
                         <p for="dictTitle" class="col-md-3 control-label"><span class="text-required">*</span>属性名称：</p>
                         <div class="col-md-8">
                             <div>
                     ...
                     <div class="form-group">
                         <p for="dictTitle" class="col-md-3 control-label"><span class="text-required">*</span>控件类型：</p>
                         <div class="col-md-8">
                             <div>
                     ...
                     <button type="button" class="btn btn-success btn-flat" id="btn_add_row">新增属性值</button>
				   	 <div class="box-header well" data-original-title="">
						<h2><i class="glyphicon"></i>属性值列表</h2>
					 </div>
				     <div role="grid" class="box-body table-responsive">
    ...
    <!-- 自己功能模块的外部JS -->
	<script src="${contextPath}/resources/js/business/publicData/goods/goodsPropertyManager.js" type="text/javascript"></script>
