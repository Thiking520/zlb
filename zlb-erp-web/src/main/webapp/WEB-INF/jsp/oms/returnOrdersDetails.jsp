...
<style type="text/css">
	...
	#returnOrdersManageTable td,#returnOrdersManageTable th{
		border: none;
...
<body>
	<div class="box-inner">
		<div class="box-header well">
			<h2>
				<i class="glyphicon glyphicon-user"></i>订单管理>退货订单详情
			</h2>
		...
		<div class="box-content row">
			<div class="L_all_information">
				...
				<ul class="L_order_number alert alert-info">
					<li style="padding-top: 10px"><span>退款方式:</span><span
						name='tradePlatform' class="text-warning"></span>&nbsp&nbsp</li>
					<li><span>退款总额:</span><span id='orderTotalAmount'
						class="text-warning"></span></li>
					<li><span>退优惠券:</span><span id='couponsAmount'
						class="text-warning"></span></li>
					<li><span>退卡券额:</span><span id='giftCardAmount'
						class="text-warning"></span></li>
					<li><span>退积分额:</span><span id='integralDeductible'
						class="text-warning"></span></li>
					<li><span>活动优惠:</span><span id='orderDiscount' class=岁"text-warning"></span></li>
	...
	<!-- 自己功能模块的外部JS -->
	<script
		src="${contextPath}/resources/js/business/oms/returnOrdersDetails.js"
