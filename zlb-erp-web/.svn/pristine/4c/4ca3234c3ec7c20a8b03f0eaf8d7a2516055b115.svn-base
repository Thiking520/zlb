			...
			<div class="box col-md-12">
				<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-user">库存台账列表</i></h2>
					</div>
					<!-- 每个人只用关注这块区域starts -->
...
<!-- 模态框（Modal） -->
    ...
    <!-- 自己功能模块的外部JS -->
    <script src="${contextPath}/resources/js/business/wms/storagein/stockAccountList.js" type="text/javascript"></script>
</body>
</html>
