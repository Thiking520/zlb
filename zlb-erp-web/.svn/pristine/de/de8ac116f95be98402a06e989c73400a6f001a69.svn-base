...
<body>
		...
		<div>
				<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-user"></i>供应商管理>供应商经理审批</h2>
					</div>
								...
								<div class="form-group">
									...
									<div class="input-group input-append date form_datetime">
										<input type="text" class="form-control datebimg" value=""
											id="datetimepickerStart" readonly style="background-color: white;width: 190px;">
	...
	<!-- 供应商经理审批 -->
		<div class="modal fade" id="managerCheckModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		    <div class="modal-dialog" style="width:1000px" role="document">
		      <div class="modal-content">
		      
			        <div class="modal-header">
			          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
			          <h4 class="modal-title" id="myModalLabel">供应商经理审批</h4>
			        </div>
			        <!-- end header -->
...
<script src="${contextPath}/resources/js/business/pms/supplierManagerExamineAndApprove.js" type="text/javascript"></script>
