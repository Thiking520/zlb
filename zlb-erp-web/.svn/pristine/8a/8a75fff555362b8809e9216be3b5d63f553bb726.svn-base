...
<body>
		...
		<div>
			<div class="box-inner">
				<div class="box-header well" data-original-title="">
					<h2>
						<i class="glyphicon glyphicon-user"></i>配送管理>首页
					</h2>
					<!-- 嵌入我负责的站点界面 -->
				...
				<div class="box-content row">
					...
					<div class="alert alert-info"
						style="width: 100%; margin-top: 10px; height: 50px;">
						<div class="control-group col-md-2">
							<div class="form-group" style="margin-top: -8px; width: 80%">
								<select id="topCitySelect" class="form-control"
									disabled="disabled">
								</select>
							</div>
						</div>
						<div class="control-group col-md-2">
							<div class="form-group" style="margin-top: -8px; width: 80%">
								<select id="topAreaSelect" class="form-control">
								</select>
							</div>
						</div>
						...
						<div class="control-group col-md-2">
							<div class="btn-group" style="margin-top: -8px;">
								<button type="button"
									class="btn btn-primary dropdown-toggle L_Popup1"
									data-toggle="dropdown">
									今日排线 <span class="caret"></span>
								</button>

								<div class="alert alert-danger L_specific_Popup1"
									style="z-index: 99; width: 1200px; min-height: 500px; position: absolute; top: 40px; left: -460px; display: none; overflow-y: auto;">
									<table
										class="table table-striped table-bordered bootstrap-datatable responsive"
										id="flatCableList">
									</table>
									<div style="position: relative;">
										<button id="todayAffirm"
											class="btn btn-primary btn-sm L_btn_disappear"
											style="position: absolute; top: 20px; left: 400px;">确认</button>
										<button id="todayCancle"
											class="btn btn-primary btn-sm L_btn_disappear"
											style="position: absolute; top: 20px; left: 500px;">取消</button>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="box-content" style="width: 98%; margin: 0 auto;">
						<ul class="nav nav-tabs" id="myTab">
							<li class="active"><a href="#info">地图排线</a></li>
						</ul>
					</div>
					<div id="myTabContent" class="tab-content">
						<div class="tab-pane active" id="info">
							...
							<div style="width: 100%; min-height: 850px;"
								...
								<!-- 左边baidu地图开始 -->
								<div id="allmap" class="box col-md-9"
								...
								<!-- 右边地址详情结束 -->
								<div class="box col-md-3" style="margin-top: 100px;">
									<p>
										<a href="">合计</a>
									</p>
									<p>
						...
						<div class="tab-pane" id="custom">
							...
							<div id="toolbar" class="btn-group" style="margin-top: 5px;">
								<button class="btn btn-default btn-sm" id="btn_show_look">
									<span class="glyphicon glyphicon-zoom-in" style="color: green;"></span>查看
								</button>
								<!-- <button id='btnDsspatchVehicle' class="btn btn-default btn-sm"
										data-toggle="modal">
										<span class="glyphicon glyphicon-road" style="color: green;"></span>派车
									</button>
									-->
				...
				<div class="modal-body">
					...
					<div style="height: 200px; margin-top: 30px;">
						<p class="text-success"
							...
							<span class="text-required">*</span>派车信息
						</p>
						<div class="col-md-4">
						...
						<div class="col-md-4">
							<p class="col-md-4" style="line-height: 35px;">长（CM）</p>
						...
						<div class="col-md-4">
							<p class="col-md-5" style="line-height: 35px;">宽（CM）</p>
							<p class="col-md-7">
						...
						<div class="col-md-4">
							<p class="col-md-4" style="line-height: 35px;">高（CM）</p>
					...
					<div style="height: 180px;">
						...
						<div>
							<div class="col-md-2 text-center">
								<span class="text-required">*</span>路线描述
							</div>
							<textarea id='cableDescribe'
								class="col-md-10 alert alert-danger "
					...
					<div class="box-content">
						...
						<div role="grid" class="box-body table-responsive">
							...
							<div role="grid"
								...
								<div class="modal-footer">
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<button id='queButton' class="btn btn-success btn-flat">确认</button>
									&nbsp;
									<button id='qvButton' class="btn btn-primary btn-flat">取消</button>
								</div>
	...
	<script
		src="${contextPath}/resources/js/business/tms/waybillHomepage.js"
		type="text/javascript"></script>
	<script
