			...
			<div >
				<div class="box-inner">
					<div class="box-header well" data-original-title="">
						<h2><i class="glyphicon glyphicon-user">库存查询>库存展望量</i></h2>
					</div>
					<!-- 每个人只用关注这块区域starts -->
...
<!-- 模态框（Modal） -->
    ...
    <!-- 自己功能模块的外部JS -->
    <script src="${contextPath}/resources/js/business/wms/storagein/outLookList.js" type="text/javascript"></script>
</body>
</html>
